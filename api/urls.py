...
urlpatterns = [
    ...
    path('project-plans/<int:project_id>/answers/', views.manage_project_answers, name='manage_project_answers'),
    path('project-plans/<int:project_id>/complete-phase1/', views.complete_project_phase1, name='complete_project_phase1'),
    path('project-plans/<int:project_id>/hide/', views.hide_project_plan, name='hide_project_plan'),
    path('project-plans/<int:project_id>/generate-title/', views.generate_project_title, name='generate_project_title'),
    path('project-plans/<int:project_id>/update-title/', views.update_project_title, name='update_project_title'),
    path('project-plans/<int:project_id>/lock-phase1/', views.lock_phase1, name='lock_phase1'),
    path('project-plans/<int:project_id>/generate-ai-questions/', views.generate_ai_questions, name='generate_ai_questions'),
] 